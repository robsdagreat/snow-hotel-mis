...
<body>
    ...
    <?php foreach ($data as $row): ?>
        <tr>
            ...
            <td><?= htmlspecialchars($row['consumable_id']) ?></td>
            <td><?= htmlspecialchars($row['quantity']) ?></td>
            <td><?= htmlspecialchars($row['unit_price']) ?></td>
            <td><?= htmlspecialchars($row['total_value']) ?></td>
            <td>
                <?php 
                // Assuming the threshold is stored elsewhere, or using a default value
                $threshold = 10; // Set a default threshold or retrieve from elsewhere
            ...
            <td>
                <div class="actions">
                    ...
                    <a href="stock_history.php?id=<?= $row['consumable_id'] ?>" class="btn btn-sm btn-primary">History</a>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>
...
<div class="add-new-link">
    <a href="add_stock.php" class="btn btn-primary">Add New Item</a>
    <a href="add_stock_quantity.php" class="btn btn-success">Restock Items</a>
</div>
</div>
