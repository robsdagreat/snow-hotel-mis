...
<head>
    ...
    <title>Add Service - Snow Hotel Management System</title>
                ...
                <form action="../controllers/services_controller.php" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="service" name="service" class="form-control" required placeholder="Enter service name">
                        </div>
                    </div>
