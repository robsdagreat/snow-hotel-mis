...
<head>
    ...
    <title>Manage Stock - Snow Hotel Management System</title>
...
<body>
    <div class="layout">
        ...
        <main class="main-content">
            ...
            <div class="form-container">
                <h2 class="form-title">Manage Inventory Stock</h2>
                ...
                <form action="../controllers/stock_controller.php" method="POST">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="transaction_type" id="transaction_type" class="form-control" required onchange="updateStockWarning();">
                        ...
                        <div class="form-group">
                            <label for="consumable_id" class="form-label">Select Consumable:</label>
                            <select name="consumable_id" id="consumable_id" class="form-control" required onchange="updateUnitPrice(); updateUnit(); updateStockWarning();">
                                <option value="">-- Select --</option>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="quantity" class="form-label">Quantity (in <span id="item_unit">units</span>)</label>
                            <input type="number" id="quantity" name="quantity" class="form-control" required min="1" placeholder="Enter quantity" onkeyup="updateStockWarning();" onchange="updateStockWarning();">
                            <div id="stock-warning" class="stock-warning"></div>
                        </div>
                        
                        <div class="form-group">
                            <label for="unit_price" class="form-label">Unit Price (per <span id="item_unit1">unit</span>)</label>
                            <input type="number" id="unit_price" name="unit_price" class="form-control" required min="1" readonly>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="description" class="form-label">Description:</label>
                        <textarea id="description" name="description" class="form-control" placeholder="Describe reason for this transaction..." rows="4"></textarea>
                    </div>
    ...
    <script>
        ...
        function updateUnit() {
            ...
            document.getElementById('item_unit').textContent = itemUnit || 'units';
            document.getElementById('item_unit1').textContent = itemUnit || 'unit';
        }
