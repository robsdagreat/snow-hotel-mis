...
$breadcrumb_page = "Edit Consumable";
...
<head>
    ...
    <title>Edit Consumable - Snow Hotel Management System</title>
    ...
    <div class="layout">
        ...
        <main class="main-content">
            ...
            <div class="form-container">
                <h2 class="form-title">Update Consumable Details</h2>
                ...
                <form action="../controllers/consumables_controller.php" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="item" name="item" class="form-control" value="<?= htmlspecialchars($consumable['item']) ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="service_id" name="service_id" class="form-control" required>
                                ...
                                <?php foreach ($services as $service): ?>
                                    <option value="<?= htmlspecialchars($service['id']) ?>" <?= ($service['id'] == $consumable['service_id']) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="unit" id="unit" class="form-control" required>
                                ...
                                $units = [
                                    ...
                                    "Liter (L)", "Milliliter (mL)", "Cup",
                                    "Piece", "Unit", "Pack", "Box", "Carton",
                                    "Bundle", "Dozen", "Pair", "Set",
                                    "Bottle", "Jar", "Can", "Tube", "Tin",
                                    "Bag", "Packet", "Sachet", "Meter (m)",
                                    "Centimeter (cm)", "Roll", "Tray", "Slice",
                                    "Case", "Sack", "Envelope", "Cylinder"
                                ];
                                
                                foreach ($units as $unit): ?>
                                    <option value="<?= htmlspecialchars($unit) ?>" <?= ($unit == $consumable['unit']) ? 'selected' : '' ?>>
